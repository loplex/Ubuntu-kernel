                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <%
                                                                ...
                                                                passed = 0
                                                                failed = 0
                                                                for suite in record['results']['autotest']:
                                                                    s = record['results']['autotest'][suite]
                                                                    total  += s['total']
                                                                ...
                                                                link = "%s__%s__%s/results-index.html" % (record['attributes']['environ']['HOSTNAME'], record['attributes']['kernel'], ts)
                                                            ...
                                                            <tr>
                                                                <td>&nbsp;</td>
                                                                <!--
                                                                <td><a href="test-results/${ record['attributes']['platform']['hostname'] }.html">${ record['attributes']['environ']['HOSTNAME'] }</a></td>
                                                                -->
                                                                <td>${ record['attributes']['environ']['HOSTNAME'] }</td>
