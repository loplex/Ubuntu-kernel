                            ...
                            <tr>
                                <td width="100%" valign="top">
                                    <table width="100%" style="font-size: 0.9em">
                                        ...
                                        % for case in test_results['autotest'][target_suite]['cases']:
                                            <%
                                                c = test_results['autotest'][target_suite]['cases'][case]
                                                d = int(float(c['duration']))
                                                hrs     = d / 3600
                                                minutes = (d / 60) % 60
                                                seconds = d
                                            ...
                                            %>
                                            <tr>
                                                <td>&nbsp;</td><td><a href="${ error_link }">${ case }</a></td> <td align="center">${ duration }</td><td style="color: ${ status_color }">${ status }</td>
                                            </tr>
                                        % endfor
                                    </table>
                                </td>
