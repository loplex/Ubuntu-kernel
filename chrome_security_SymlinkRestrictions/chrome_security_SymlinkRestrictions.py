...
class chrome_security_SymlinkRestrictions(test.test):
    version = 1
    ...
    def run_once(self):
        ...
        utils.system("su -c 'ln -s /etc/shadow /tmp/evil-symlink' phablet")
        ...
        self._check_symlinks(sticky=False, userone='root', usertwo='phablet')
        self._check_symlinks(sticky=False, userone='phablet', usertwo='root')
        self._check_symlinks(sticky=True, userone='root', usertwo='phablet')
        self._check_symlinks(sticky=True, userone='phablet', usertwo='root')
